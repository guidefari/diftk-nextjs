    ...
    <footer className="flex justify-center px-4 bg-secondary">
      <div className="container py-6">
        <h1 className="text-lg font-bold text-center lg:text-2xl">
          Stay up to date with all things DIFTK, <br />
          Magazine articles, projects and more.
        </h1>
        ...
        >
          ...
          <div className="rounded-md bg-background">
            <div className="flex flex-wrap justify-between md:flex-row">
              <input
                type="email"
                className="p-2 m-1 text-sm text-gray-700 appearance-none bg-background focus:outline-none focus:placeholder-background"
                placeholder="Enter your email"
                name="email"
              />
              <button
                type="submit"
                className="w-full p-2 m-1 text-sm font-semibold uppercase rounded lg:w-auto button-secondary"
              >
